...
### Visual Studio
[Windowsでの環境構築(Visual Studioの場合)](2020-3-25-chapter6-windows-visualstudio)

Windowsを開発しているMicrosoftから出されている開発環境です。Windows向けの様々なゲームやアプリなどを作るのに向いています。設定が簡単なので初心者向けでもあります。対象:ゲーム班、簡単に設定できるのが良い人

### MinGW
[Windowsでの環境構築(MinGWの場合)](2020-3-25-chapter6-windows-mingw)
...
### XCode
[Macでの環境構築(XCodeの場合)](2020-3-25-chapter6-mac-xcode)
...
### Homebrew
[Macでの環境構築(Homebrewの場合)](2020-3-25-chapter6-mac-gcc)
...
[VirtualBoxのインストール(Windows)](2020-3-25-chapter6-virtualbox-windows)

[VirtualBoxのインストール(Mac)](2020-3-25-chapter6-virtualbox-mac)

### Ubuntuの仮想環境の作成
実際にUbuntuを動かす環境を作成します

[Ubuntuの仮想環境の作成](2020-3-25-chapter6-ubuntu-virtualmachine)