...
2. 「**xcode**」と左上の検索欄に入力し、Xcodeと書かれたアプリをダウンロードします。
 ...
 <img src="/beginners/assets/chapter6/Chapter6_mac_xcode/xcode_appstore_view.png" alt="appstore内のXcodeの画像" width="30%" margin="10px">  
 <img src="/beginners/assets/chapter6/Chapter6_mac_xcode/xcode_first_page.png" alt="Xcodeの最初の画面" width="30%" margin="10px">
 <img src="/beginners/assets/chapter6/Chapter6_mac_xcode/xcode_macos_page.png" alt="Xcodeプロジェクト新規作成の画面" width="30%" margin="10px">
