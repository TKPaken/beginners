...
　先ほどの項で、問題によって点数が違い、それによって難易度が大きく異なることを述べました。
...
|Longest Streak|「一日も空けずに一問以上新しい問題を解き続ける」ことを最も継続したときの長さ|
...
　まず初めに、競技プログラミングやAtCoderが初めての人たちのために説明している記事です。
これを読めば、AtCoderのシステムや競技プログラミングのおおよその雰囲気がつかめるでしょう。
これはこのあとすぐ、じっくり目を通しておくことをおすすめします。

以下はこれから実力をつけていく上で必要になることがまとまっている記事群です。
...
プログラミングにおいて、「ライブラリ」という考え方があります。
よく使うプログラム(たとえば、二つの数の最大公約数を求める、など)をあらかじめ持っておき、すぐ使えるようにしておく、というものです。(ざっくり)
...
　この世界には、「蟻本（正式名称:プログラミングコンテストチャレンジブック）」と呼ばれる競技プログラミングの教科書があります。
